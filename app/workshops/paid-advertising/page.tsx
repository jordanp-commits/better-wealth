  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-[75vh] flex items-end">
        <div className="absolute inset-0" style={{ backgroundImage: "url('/cortland-dining.png')", backgroundSize: 'cover', backgroundPosition: 'center', filter: 'brightness(0.35) saturate(0.7) sepia(0.3)' }} />
