            ...
            <div className="bg-white rounded-2xl p-8 md:p-12" style={{ border: '1px solid rgba(0,0,0,0.07)', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
              ...
              <div className="mb-12 pb-8" style={{ borderBottom: '1px solid rgba(0,0,0,0.1)' }}>
                ...
                <nav className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                  <a href="#who-we-are" className="hover:underline" style={{ color: '#C4926A' }}>1. Who We Are</a>
                  <a href="#information-we-collect" className="hover:underline" style={{ color: '#C4926A' }}>2. Information We Collect</a>
                  <a href="#how-we-use" className="hover:underline" style={{ color: '#C4926A' }}>3. How We Use Your Information</a>
                  <a href="#third-party" className="hover:underline" style={{ color: '#C4926A' }}>4. Third-Party Services</a>
                  <a href="#data-retention" className="hover:underline" style={{ color: '#C4926A' }}>5. Data Retention</a>
                  <a href="#your-rights" className="hover:underline" style={{ color: '#C4926A' }}>6. Your Rights Under UK GDPR</a>
                  <a href="#cookies" className="hover:underline" style={{ color: '#C4926A' }}>7. Cookies</a>
                  <a href="#security" className="hover:underline" style={{ color: '#C4926A' }}>8. Security</a>
                  <a href="#international" className="hover:underline" style={{ color: '#C4926A' }}>9. International Transfers</a>
                  <a href="#children" className="hover:underline" style={{ color: '#C4926A' }}>10. Children's Privacy</a>
                  <a href="#marketing" className="hover:underline" style={{ color: '#C4926A' }}>11. Marketing Communications</a>
                  <a href="#changes" className="hover:underline" style={{ color: '#C4926A' }}>12. Changes to This Policy</a>
                  <a href="#contact" className="hover:underline" style={{ color: '#C4926A' }}>13. Contact Us</a>
                </nav>
              </div>
              ...
              <section id="who-we-are" className="mb-10">
                ...
                <div className="space-y-3 text-sm leading-relaxed" style={mutedDark}>
                  ...
                  <p><strong>Contact:</strong> <a href="mailto:info@better-wealth.co.uk" className="underline" style={{ color: '#C4926A' }}>info@better-wealth.co.uk</a></p>
              ...
              <section id="information-we-collect" className="mb-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed ml-4" style={mutedDark}>
              ...
              <section id="how-we-use" className="mb-10">
                ...
                <p className="text-sm leading-relaxed mb-4" style={mutedDark}>We use your personal data to:</p>
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed ml-4 mb-6" style={mutedDark}>
              ...
              <section id="third-party" className="mb-10">
                ...
                <p className="text-sm leading-relaxed mb-4" style={mutedDark}>We share data with the following trusted service providers:</p>
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed ml-4" style={mutedDark}>
                ...
                <p className="text-sm leading-relaxed mt-4" style={mutedDark}>
              ...
              <section id="your-rights" className="mb-10">
                ...
                <p className="text-sm leading-relaxed mb-4" style={mutedDark}>You have the right to:</p>
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed ml-4" style={mutedDark}>
                ...
                <p className="text-sm leading-relaxed mt-4" style={mutedDark}>
                  To exercise these rights, email: <a href="mailto:info@better-wealth.co.uk" className="underline" style={{ color: '#C4926A' }}>info@better-wealth.co.uk</a>
                </p>
              </section>
              ...
              <section id="cookies" className="mb-10">
                ...
                <p className="text-sm leading-relaxed mb-4" style={mutedDark}>We use cookies for:</p>
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed ml-4" style={mutedDark}>
                ...
                <p className="text-sm leading-relaxed mt-4" style={mutedDark}>
                  For detailed information about the cookies we use and how to manage your preferences, please see our <Link href="/cookie-policy" className="underline" style={{ color: '#C4926A' }}>Cookie Policy</Link>. You can change your cookie preferences at any time via our cookie banner or on the Cookie Policy page.
                </p>
              </section>
              ...
              <section id="marketing" className="mb-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed ml-4" style={mutedDark}>
                  ...
                  <li>Emailing <a href="mailto:info@better-wealth.co.uk" className="underline" style={{ color: '#C4926A' }}>info@better-wealth.co.uk</a></li>
              ...
              <section id="contact">
                ...
                <p className="text-sm leading-relaxed" style={mutedDark}>
                  <strong>Email:</strong> <a href="mailto:info@better-wealth.co.uk" className="underline" style={{ color: '#C4926A' }}>info@better-wealth.co.uk</a>
                </p>
                <p className="text-sm leading-relaxed mt-4" style={mutedDark}>
