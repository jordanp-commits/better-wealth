...
const faqs = [
  {
    question: "Who are Better Wealth events designed for?",
    answer: "Our events are built for ambitious professionals in financial services and real estate—mortgage advisors, financial planners, estate agents, wealth managers, and property professionals looking to grow their client base and income through targeted marketing strategies. Most attendees are earning £75k+ and want practical, industry-specific education they can implement immediately."
  },
  {
    question: "What makes Better Wealth different from other business training programs?",
    answer: "We're not motivational speakers. We're practitioners. Every event is built around tangible deliverables—you leave with frameworks, templates, and action plans ready to implement. We focus exclusively on financial services and real estate, so everything we teach accounts for FCA compliance, client trust dynamics, and the realities of regulated industries. And our community is vetted, not open-access."
  },
  {
    question: "Do I need marketing experience to attend?",
    answer: "No. Our events are designed for complete beginners through to experienced marketers. We cover setup, strategy, and execution—so whether you've never run a paid ad or you're looking to refine your existing campaigns, the content is structured to meet you where you are."
  },
  {
  ...
  {
    question: "What happens after I attend an event?",
  ...
  {
    question: "Are events recorded or available online?",
